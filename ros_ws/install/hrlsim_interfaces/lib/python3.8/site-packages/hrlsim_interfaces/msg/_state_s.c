...
bool hrlsim_interfaces__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hrlsim_interfaces.msg._state.State", full_classname_dest, 34) == 0);
  }
  hrlsim_interfaces__msg__State * ros_message = _ros_message;
  {  // pose
...
PyObject * hrlsim_interfaces__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hrlsim_interfaces.msg._state");
  ...
  hrlsim_interfaces__msg__State * ros_message = (hrlsim_interfaces__msg__State *)raw_ros_message;
  {  // pose
    PyObject * field = NULL;
