...
class LQR(controller.Controller):
    ...
    def computeControl(
        self, t0: float, dt: float, state: hrlsim.airsim.MultirotorState, drone_name
        ...
        """
        p = state.kinematics_estimated.position.to_numpy_array()
        ...
        elapsed_time = rospy.get_time() - self.prev_gain_time
